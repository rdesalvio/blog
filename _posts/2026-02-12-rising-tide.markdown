...
It's in spaces like this where AI becomes the rising tide which lifts all boats. A project that was perhaps just out of reach before, becomes easily within reach. So I made [nhlfantasydata](http://www.nhlfantasydata.com/). It's intentionally a barebones, ad-less, and speedy site which surfaces the information I want easily. 

It's mobile friendly and hosted/automated on my own infrastructure, making it extremely cheap to run. While I really hope this site is useful for others (I think it may, based on the existing sites available), this site is unabashedly for **me**. Because it's a tool I use daily, I will support it and always keep it free to use and ad-free.